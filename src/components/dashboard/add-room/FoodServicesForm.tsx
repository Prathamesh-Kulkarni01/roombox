    ...
    return (
        <div className="space-y-6 pt-6">
            <FormField control={form.control} name="foodIncluded" render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                        <FormLabel>Food Included? (Optional)</FormLabel>
            ...
            {foodIncluded && (
                <div className="space-y-4 pl-4 border-l-2 ml-2">
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel>Meals Provided (Optional)</FormLabel>
                                <FormControl>
                                    <MultiSelect
                                        options={mealOptions}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel>Veg/Non-Veg Options (Optional)</FormLabel>
                                <FormControl>
            ...
            <FormField control={form.control} name="housekeepingFrequency" render={({ field }) => (
                <FormItem>
                    <FormLabel>Housekeeping Frequency (Optional)</FormLabel>
            ...
            <FormField control={form.control} name="laundryServices" render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                        <FormLabel>Laundry Services Available? (Optional)</FormLabel>
