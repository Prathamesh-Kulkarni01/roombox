...
export function PWASettings() {
  ...
  const brandedUrl = subdomainValue
    ? getRedirectUrlForSubdomain("tenant", subdomainValue, "")
    : "";

  const qrDarkColor = (themeColorValue || "#0f172a").replace("#", "");
  const qrCodeUrl = brandedUrl
    ? `https://quickchart.io/qr?text=${encodeURIComponent(brandedUrl)}&size=300&dark=${qrDarkColor}&margin=2${logoValue && !logoValue.startsWith("data:image/svg+xml") ? `&centerImageUrl=${encodeURIComponent(logoValue)}` : ""}`
    : "";
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <CardDescription className="text-base mt-2">
                  Customize how the app looks when your tenants install it on
                  their phones.
                </CardDescription>
              </div>
            </div>
                        ...
                        <FormControl>
                          <div className="flex items-center shadow-sm rounded-md overflow-hidden border border-border/50">
                            ...
                            <Input
                              {...field}
                              placeholder="your-pg"
                              className="border-0 h-12 rounded-none focus-visible:ring-0 bg-muted/30"
                            />
                          </div>
                        </FormControl>
                        <FormDescription>
                          The link you will share with your tenants to access
                          the app.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                          ...
                          <FormControl>
                            <div className="flex gap-3 items-center">
                              ...
                              <Input
                                ...
                                className="h-12 bg-muted/30 border-border/50 uppercase font-mono text-sm"
                              />
                            </div>
                          </FormControl>
                          <FormDescription>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Background color while opening.
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                        ...
                        {PRESET_ICONS.map((item) => (
                          <Button
                            ...
                            onClick={() => {
                              ...
                              toast({
                                title: "Icon Selected",
                                description: `Selected the ${item.label} icon.`,
                              });
                            }}
                          >
                            <div
                              ...
                              style={{
                                backgroundColor:
                                  form.watch("logo") ===
                                  PRESET_ICON_SVGS[item.id]
                                    ? form.watch("themeColor")
                                    : "#f1f5f9",
                              }}
                            >
                              <item.icon
                                className={`w-6 h-6 ${form.watch("logo") === PRESET_ICON_SVGS[item.id] ? "text-white" : "text-slate-700"}`}
                              />
                            </div>
        ...
        <div className="sticky top-8 space-y-8">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-slate-500">
              See exactly what your tenants will see
            </p>
          </div>
                ...
                {previewMode === "dashboard" && (
                  <>
                    ...
                    <div className="z-10 w-full px-6 pt-24 animate-in slide-in-from-bottom-4 fade-in duration-700">
                      <div className="w-28 h-28 mx-auto rounded-[2rem] shadow-xl border-4 border-white mb-6 flex items-center justify-center overflow-hidden transition-all duration-500 bg-white">
                        {logoValue ? (
                          <img
                            src={logoValue}
                            alt="App Logo"
                      ...
                      <h4 className="text-2xl font-bold tracking-tight text-slate-900 mb-2 truncate px-2">
                        {nameValue || "Your App Name"}
                      </h4>
                      ...
                      <div className="mt-12 space-y-4 w-full px-2">
                        <div
                          className="h-12 w-full rounded-2xl flex items-center justify-center text-white font-bold shadow-lg transition-colors duration-500 text-base"
                          style={{ backgroundColor: themeColorValue }}
                        >
                          Login to Dashboard
                        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-600 mt-2">
                Share this link or QR code with your tenants so they can access
                their dashboard through your branded app.
              </p>
            </div>
              ...
              <div className="flex-1 space-y-6 w-full text-center md:text-left">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <Input
                      readOnly
                      value={brandedUrl}
                      className="bg-muted/30 border-border/50 h-12 text-foreground font-medium"
                    />
                    <Button
                      size="icon"
                ...
                <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                  <Button
                    onClick={() =>
                      window.open(
                        `https://wa.me/?text=${encodeURIComponent(`Check out our new property app to manage your stay: ${brandedUrl}`)}`,
                        "_blank",
                      )
                    }
                    className="bg-[#25D366] hover:bg-[#20ba5a] text-white h-12 px-6 rounded-xl text-base font-semibold shadow-sm"
                  >
                  ...
                  <Button
                    variant="outline"
                    asChild
                    className="h-12 px-6 rounded-xl text-base font-semibold border-border/50 hover:bg-muted text-foreground"
                  >
                    <a
                      href={brandedUrl}
                      target="_blank"
            ...
            <div className="mt-6 flex items-start gap-3 text-sm text-indigo-800 bg-indigo-100/50 p-4 rounded-xl">
              ...
              <p>
                <strong>Pro Tip:</strong> Print the QR code and paste it at your
                reception. New tenants can scan it to instantly get your branded
                app on their phones!
              </p>
            </div>
          </div>
