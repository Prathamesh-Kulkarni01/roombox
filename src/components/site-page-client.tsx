    ...
    <div className="bg-background text-foreground">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
                <Image src="https://picsum.photos/seed/sutrasite/600/400" width={600} height={400} alt="Group of people in a common area" className="rounded-lg shadow-lg" data-ai-hint="people community" />
            </div>
        </div>
      </section>
...
export default function SitePageClient({ initialData, subdomain }: SitePageClientProps) {
  ...
  if (singlePg) {
    return <SinglePgView pg={singlePg} owner={owner} siteConfig={siteConfig} subdomain={subdomain}/>;
  }
