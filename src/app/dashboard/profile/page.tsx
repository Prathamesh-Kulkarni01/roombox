...
export default function ProfilePage() {
  ...
  const isStaff = ["manager", "cook", "cleaner", "security", "other"].includes(
    currentUser.role,
  );
      ...
      <div className="flex flex-col items-center gap-4 py-6 bg-gradient-to-b from-primary/5 to-transparent rounded-3xl border border-primary/10">
        ...
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-2 mt-1">
            <Badge
              variant="secondary"
              className="capitalize font-bold px-3 py-0.5 rounded-full"
            >
              {currentUser.role}
            </Badge>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between group">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[10px] font-black uppercase tracking-wider text-muted-foreground opacity-50">
                  Phone Number
                </p>
            ...
            <Button
              ...
              onClick={() =>
                copyToClipboard(currentUser.phone || "", "Phone Number")
              }
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-bold text-sm">
                    {assignedPg?.name || "All Properties"}
                  </p>
                </div>
              </div>
            </div>
          ...
          <Card className="border-border/40 shadow-sm rounded-3xl overflow-hidden">
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2">
                {currentUser.permissions.map((p: string) => (
                  <Badge
                    key={p}
                    variant="outline"
                    className="bg-primary/5 text-primary border-primary/20 font-semibold px-3 py-1 rounded-lg"
                  >
                    {p
                      .split("_")
                      .map(
              ...
              <p className="text-[10px] text-muted-foreground mt-4 italic font-medium">
                * Permissions are managed by the property owner. Contact them
                for changes.
              </p>
            </CardContent>
          </Card>
      ...
      <div className="grid grid-cols-1 gap-3 mt-4">
        <Button
          ...
          onClick={() =>
            toast({
              title: "Coming Soon",
              description: "Password change feature is being developed.",
            })
          }
        >
