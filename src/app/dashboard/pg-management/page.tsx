...
export default function PgManagementPage() {
  ...
  const canManageCharges = canAccess(
    featurePermissions,
    currentUser?.role,
    "properties",
    "sharedCharge",
  ...
  const {
    ...
    addTemplate,
    updateTemplate: updateTemplateZustand,
    deleteTemplate,
  } = useChargeTemplatesStore();
  const [isTemplateDialogOpen, setIsTemplateDialogOpen] = useState(false);
  const [templateToEdit, setTemplateToEdit] = useState<ChargeTemplate | null>(
    null,
  );
    ...
    try {
      ...
      if (templateToEdit) {
        ...
        toast({
          ...
          description: "Your charge template has been updated.",
        });
      } else {
        addTemplate(templateData);
        toast({
          title: "Template Created",
          description: "Your new charge template is ready to use.",
        });
      }
  ...
  const canAddPg =
    ...
    pgs.length < (currentPlan.pgLimit as number);

  const handleAddPgClick = () => {
    if (currentPlan && !canAddPg) {
      toast({
        variant: "destructive",
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Tabs defaultValue="properties" className="w-full">
        <TabsList
          className={cn(
            "grid w-full max-w-[400px]",
            canManageCharges ? "grid-cols-2" : "grid-cols-1",
          )}
        >
                                ...
                                <DropdownMenu>
                                  ...
                                  <DropdownMenuContent align="end">
                                    ...
                                    <Access feature="properties" action="add">
                                      ...
                                      >
                                        <Zap className="mr-2 h-4 w-4" /> Bulk
                                        Setup Rooms
                                      </DropdownMenuItem>
                                    </Access>
                                    <DropdownMenuItem>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground capitalize">
                      {template.frequency}, {template.calculation} based, cycle
                      on day {template.billingDayOfMonth}
                    </p>
                  </div>
              ...
              {canManageCharges && (
                ...
                >
                  <PlusCircle className="mr-2 h-4 w-4" /> Add New Charge
                  Template
                </Button>
              )}
            </CardContent>
      ...
      >
        <DialogContent className="sm:max-w-md">
          ...
          <Form {...chargeTemplateForm}>
            <form
              onSubmit={chargeTemplateForm.handleSubmit(handleTemplateSubmit)}
              className="space-y-4"
            >
              <FormField
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      The day of month when the bill is generated.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>
                        Show this template by default in rent collection.
                      </FormDescription>
                    </div>
                    <FormControl>
                      <Switch
      ...
      <AlertDialog
        open={!!pgToDelete}
        onOpenChange={(open) => !open && setPgToDelete(null)}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => setPgToDelete(null)}>
              Cancel
            </AlertDialogCancel>
            <Access feature="properties" action="delete">
              <AlertDialogAction
