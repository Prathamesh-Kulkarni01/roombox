        ...
        <div className="space-y-6">
            ...
            <Card>
                <Form {...kycForm}>
                    <form onSubmit={kycForm.handleSubmit(handleSaveKyc)} className="space-y-6">
                        ...
                        <CardFooter><Button type="submit" disabled={isSaving}>{isSaving && <Loader2 className="animate-spin mr-2 h-4 w-4" />}Save KYC Information</Button></CardFooter>
                    </form>
                </Form>
            </Card>
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                    <div><CardTitle className="flex items-center gap-2"><HandCoins/> Payout Methods</CardTitle><CardDescription>Manage your linked bank accounts and UPI IDs to receive rent settlements.</CardDescription></div>
            ...
            <Dialog open={isPayoutDialogOpen} onOpenChange={setIsPayoutDialogOpen}>
                <DialogContent>
                    <DialogHeader><DialogTitle>Add New Payout Method</DialogTitle><DialogDescription>Link a UPI ID or Bank Account to receive rent settlements.</DialogDescription></DialogHeader>
                    <Form {...payoutForm}>
