...
export default function WebsiteBuilderPage() {
    ...
    try {
      ...
      if (config) {
        ...
        form.reset({
          ...
          featuresDescription:
            "We provide top-notch facilities to ensure a comfortable stay.",
          features: [],
          faqs: [],
          testimonials: [],
          subdomain: "",
  ...
  const onSubmit = (
    ...
    startTransition(async () => {
      ...
      if (result.success && result.config) {
        toast({
          title: "Success!",
          description: `Your website has been ${status === "published" ? "published" : "saved as a draft"}.`,
        });
  ...
  const handleDelete = async () => {
    ...
    if (result.success) {
      toast({
        title: "Success",
        description: "Your public website has been deleted.",
      });
      setSiteConfig(null);
    ...
    try {
      if (navigator.share) {
        ...
        toast({
          ...
          description: "Website URL copied.",
        });
      }
    } catch (error) {
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center text-center p-8 bg-muted/50 rounded-lg border">
            ...
            <p className="mt-2 text-muted-foreground max-w-sm">
              The Website Builder is a premium feature. Please recharge your
              ...
              <TabsContent value="branding" className="mt-6">
                <div className="space-y-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Brand / App Name</FormLabel>
                        <Input
                          placeholder="e.g., Sunshine PG & Hostels"
                          {...field}
                        />
                        <FormDescription>
                          This name appears on your website, PWA, and in search
                          results.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                  ...
                  <div className="grid md:grid-cols-2 gap-6 items-center">
                    ...
                    <FormField
                      ...
                      render={() => (
                        <FormItem>
                          <FormLabel>Your Favicon / App Icon</FormLabel>
                ...
                <div className="grid md:grid-cols-2 gap-8 items-start">
                  <div className="space-y-6">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Your App's Subdomain</FormLabel>
                          ...
                          <FormDescription>
                            This will be your app's unique address. Cannot be
                            changed later.
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                    ...
                    <Card>
                      <CardHeader className="pb-4">
                        ...
                        <CardDescription>
                          Let tenants scan the QR code or use the buttons to
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="aspect-[9/16] bg-slate-800 rounded-2xl border-4 border-slate-600 p-4 flex flex-col items-center justify-center">
                      ...
                      <p className="text-sm text-white font-medium text-center max-w-[120px] truncate">
                        {siteTitleValue || "Your App Name"}
                      </p>
                    </div>
                  </div>
                </div>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <Textarea
                              placeholder="Describe your properties in a sentence."
                              {...field}
                            />
                            <FormMessage />
                          </FormItem>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <Textarea
                              placeholder="Tell your brand story briefly..."
                              {...field}
                            />
                            <FormMessage />
                          </FormItem>
                    ...
                    <AccordionContent className="space-y-6 pt-4">
                      <FormField
                        ...
                        render={() => (
                          <FormItem>
                            <FormDescription>
                              Select which of your properties to show on the
                              public website.
                            </FormDescription>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete your public website at{" "}
